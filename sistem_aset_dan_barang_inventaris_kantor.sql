...
CREATE TABLE `asset_images` (
  ...
  KEY `fk_img_asset` (`asset_id`),
  CONSTRAINT `fk_img_asset` FOREIGN KEY (`asset_id`) REFERENCES `assets` (`asset_id`) ON DELETE CASCADE
...
INSERT INTO `asset_images` VALUES (1,1,'https://example.com/images/laptop_dell.jpg','2026-06-26 08:29:03'),(2,5,'https://example.com/images/server_dell.jpg','2026-06-26 08:29:03'),(3,9,'https://example.com/images/mobil_avanza.jpg','2026-06-26 08:29:03');
...
--
-- Table structure for table `depreciation_log`
--

DROP TABLE IF EXISTS `depreciation_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `depreciation_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `fk_depr_asset` (`asset_id`),
  CONSTRAINT `fk_depr_asset` FOREIGN KEY (`asset_id`) REFERENCES `assets` (`asset_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `depreciation_log`
--

LOCK TABLES `depreciation_log` WRITE;
/*!40000 ALTER TABLE `depreciation_log` DISABLE KEYS */;
INSERT INTO `depreciation_log` VALUES (1,1,2024,5000000.00,20000000.00),(2,5,2024,15000000.00,60000000.00),(3,8,2024,2400000.00,9600000.00);
/*!40000 ALTER TABLE `depreciation_log` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `maintenance_requests` (
  ...
  KEY `fk_maint_user` (`requested_by`),
  CONSTRAINT `fk_maint_asset` FOREIGN KEY (`asset_id`) REFERENCES `assets` (`asset_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_maint_user` FOREIGN KEY (`requested_by`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `maintenance_requests` VALUES (1,8,3,'2024-04-10','Router sering mati sendiri dan tidak bisa connect internet','completed',NULL,500000.00),(2,4,3,'2024-06-20','Printer macet dan hasil cetak bergaris','in_progress',NULL,250000.00),(3,9,6,'2024-06-10','Ganti oli dan servis rutin 10.000 KM','completed',NULL,1500000.00);
...
INSERT INTO `vendors` VALUES (1,'PT Teknologi Maju','Budi Santoso','08123456789','budi@tekmaju.com','Jl. Sudirman No. 1'),(2,'CV Furniture Jaya','Siti Aminah','08198765432','siti@furnijaya.com','Jl. Gatot Subroto No. 5'),(3,'PT Otomotif Sentosa','Andi Pratama','08111222333','andi@otosentosa.com','Jl. Kuningan No. 10');
...
-- Dump completed on 2026-06-26 15:39:25
